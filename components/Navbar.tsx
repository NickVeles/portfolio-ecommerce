    ...
    <div className="sticky top-0 z-45 w-full">
      <div className="bg-destructive text-destructive-foreground text-center py-2 px-4 text-sm font-semibold flex items-center justify-center gap-2">
        ...
        <span className="inline">
          <span className="underline">Portfolio Project Only</span> - Do Not Use
          Real Payment Information or Personal Credentials
        </span>
      </div>
        ...
        - e.g. clicking outside the logo still triggers the Link */}
          <div className="mr-auto">
            <Link href="/" className="flex items-center gap-2 group">
              <Logo
                className="size-8 text-primary group-hover:text-secondary"
                aria-label="Velbuy Logo"
              />
              <span className="hidden sm:inline text-xl font-bold text-primary-foreground group-hover:text-secondary">
                Velbuy
              </span>
            </Link>
          </div>
          <div className="flex space-x-6 *:hover:text-secondary">
